...
String location = (String)sessions.getAttribute("location");
  System.out.println(stuid+"-----"+pincode+""+regno+"---"+jyear);
            ...
            <div class="container">
                ...
                <div id="navbar" class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li ><a href="stuinbox.jsp" style="background-color:white; color:red;" >Notification[<%=counts%>] </a></li>
...
<div align = "center" style="font-family:verdana"">
  ...
  String k = (String)request.getAttribute("dup");
  if(k != null)
  {
  	
  	out.println("<font color=#FA0505 size =4px>"+k+"</font>");
  ...
  <h2>Choose Options </h2>
     ...
     <button onclick="location.href = 'bor.jsp';" style= "background-color:#159eee; color:white;    height: 100px; width:280px;  " id="myButton"  >BONAFIDE CERTIFICATE</button>
     				<td>
										<label id="friendslab" style="font-size: 18px;">
											
										</label>
										<label style="color: red; font-size: 15px;">
										 <button onclick="location.href = 'viewstaff.jsp';" style= "background-color:#159eee; color:white;     height: 100px; width:280px;  " id="myButton1"  >LOR</button>
