...
String o = (String)request.getAttribute("no");
if(o != null)
{
...
String log = request.getParameter("sess");
if(log != null)
{
	
	out.println("<font color=#FA0505  size =4px>"+log+"</font>");
...
%>
  ...
  <br/>
            <form action = "StudentLog" method = "get"> 
  <table>
  <tr>
  <td>
