...
try{
	...
	String sql ="select * from lofrequest_copy where email = '"+email+"' ";
	ResultSet resultSet = statement.executeQuery(sql);
	while(resultSet.next()){
		
		   HttpSession session1=request.getSession();  
		   u =resultSet.getInt(15);
	        session.setAttribute("uni",u);  
	staffid = resultSet.getString(1);
memo = resultSet.getString(5);
...
<td>
<a href="lofpage.jsp?unique_id=<%=u%>">Accept</a> ||
<a href="DeclineLofCertificate?unique_id=<%=u%>">Decline</a>
</td>
